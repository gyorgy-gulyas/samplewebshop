...
namespace Sales.OrderManagement
{
	...
	{
		/// <return>IOrderIF_v1.OrderDTO</return>
		public Task<Response<IOrderIF_v1.OrderDTO>> getOrder(CallingContext ctx, string orderId);

		/// <return>IOrderIF_v1.OrderDTO</return>
		public Task<Response<IOrderIF_v1.OrderDTO>> placeOrder(CallingContext ctx, OrderDTO order);

		/// <return>IOrderIF_v1.OrderItemDTO</return>
		public Task<Response<IOrderIF_v1.OrderItemDTO>> setPrice(CallingContext ctx, OrderItemDTO orderItem, decimal price);
		...
		public partial class OrderItemDTO : IEquatable<OrderItemDTO>, IValidable
		{
			...
			public IOrderIF_v1.OrderItemDTO.DeliveryStatuses deliveryStatus { get; set; }
